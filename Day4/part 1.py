...
#    sections1 = list(range(int(se1[0]), int(se1[1])+1))
#    sections2 = list(range(int(se2[0]), int(se2[1])+1))

    if se1[0]<= se2[0] and se1[1] >= se2[1]:
        total = total + 1
        print(se2, "is in", se1)
    elif se2[0]<= se1[0] and se2[1] >= se1[1]:
        total = total + 1
        print(se1, "is in", se2)

#    if sections1 in sections2:
#        total = total + 1
#    elif sections2 in sections1:
#        total = total + 1
